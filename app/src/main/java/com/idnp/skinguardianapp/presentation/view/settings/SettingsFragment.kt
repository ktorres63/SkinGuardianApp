package com.idnp.skinguardianapp.presentation.view.settings
...
import com.idnp.skinguardianapp.domain.model.Settings
...
class SettingsFragment : Fragment() {
    ...
    private suspend fun getSettings(): Flow<Settings> = flow {
